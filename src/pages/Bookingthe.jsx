    ...
    <div className="bg-[#f6f4f4] min-h-screen py-[90px] text-[#000] mt-9 overflow-hidden">
      ...
      <div className="gap-x-5 container mt-[90px] mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6 px-4">
        ...
        <div className="relative  w-full h-[300px] rounded-lg flex flex-col items-center justify-center text-white">
          ...
          <span className='text-[#000] p-4 md:text-left text-justify'>Hey! I'm an expert web designer and developer. I specialize in building modern, user-friendly designs and developing functional online platforms.</span>
        </div>
        ...
        <div className="relative  w-full h-[300px] rounded-lg flex flex-col items-center justify-center text-white">
          ...
          <span className='text-[#000] p-4 md:text-left text-center'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi, dolor tempora minima nam est pariatur?</span>
        </div>
        ...
        <div className="relative  w-full h-[300px] rounded-lg flex flex-col items-center justify-center text-white">
          ...
          <span className='text-[#000] p-4 md:text-left text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit, consequatur provident dolores pariatur corrupti quo!</span>
        </div>
        ...
        <div className="relative  w-full h-[300px] rounded-lg flex flex-col items-center justify-center text-white">
          ...
          <span className='text-[#000] p-4 md:text-left text-center'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Vitae voluptas earum dolorum tempore itaque velit.</span>
        </div>
        ...
        <div className="relative  w-full h-[300px] rounded-lg flex flex-col items-center justify-center text-white">
          ...
          <span className='p-4 text-[#000] md:text-left text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis culpa voluptatem vitae corrupti, architecto quae.</span>
        </div>
        ...
        <div className="relative  w-full h-[300px] rounded-lg flex flex-col items-center justify-center text-white">
          ...
          <span className='text-[#000] p-4 md:text-left text-center'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illo quod aspernatur inventore dolor cum expedita.</span>
        </div>
      </div>
    </div>
  );
